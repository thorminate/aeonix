    ...
    try {
        ...
        switch (modalInteraction.customId) {
            ...
            case "stats-giver-modal":
                ...
                const statsTargetUserData = yield userDatabaseSchema_1.default.findOne({
            ...
            case "create-skill-modal":
                ...
                if (yield skillDatabaseSchema_1.default.findOne({ skillName: createSkillName })) {
                    yield modalInteraction.reply({
            ...
            case "delete-skill-modal":
                ...
                const skillUsers = yield userDatabaseSchema_1.default.find({
                ...
                const deletedSkill = yield skillDatabaseSchema_1.default.deleteOne({
            ...
            case "grant-skill-modal":
                ...
                const grantSkillTargetUserData = yield userDatabaseSchema_1.default.findOne({
                ...
                const grantSkillSkill = yield skillDatabaseSchema_1.default.findOne({
            ...
            case "revoke-skill-modal":
                ...
                // Validate the inputs
                const revokeSkillData = yield skillDatabaseSchema_1.default.findOne({
                ...
                const revokeSkillTargetData = yield userDatabaseSchema_1.default.findOne({
            ...
            case "create-item-modal":
              ...
              */
                ...
                const existingItem = yield itemDatabaseSchema_1.default.findOne({
                    itemName: itemName,
                });
                if (existingItem) {
                    modalInteraction.reply({
            ...
            case "give-item-modal":
                ...
                const giveItemAmount = modalInteraction.fields.getTextInputValue("give-item-amount-input");
                ...
                const giveItemTargetData = yield userDatabaseSchema_1.default.findOne({
                ...
                const giveItemData = yield itemDatabaseSchema_1.default.findOne({
            ...
            case "remove-item-modal":
                ...
                // Validate the inputs
                const removeItemData = yield itemDatabaseSchema_1.default.findOne({
                ...
                const removeItemTargetData = yield userDatabaseSchema_1.default.findOne({
            ...
            case "delete-item-modal":
                ...
                const deleteItemName = modalInteraction.fields
                    ...
                    .toLowerCase();
                // Validate the inputs
                const deleteItemData = yield itemDatabaseSchema_1.default.findOne({
                ...
                for (const user of deleteItemUsers) {
                    const deleteItemUserData = yield userDatabaseSchema_1.default.findOne({
                        userId: user,
                        guildId: modalInteraction.guild.id,
                    });
                    const deleteItemIndex = deleteItemUserData.inventory.findIndex((item) => item.itemName === deleteItemName);
                    if (deleteItemIndex > -1) {
                        userDatabaseSchema_1.default.inventory.splice(deleteItemIndex, 1);
                        yield userDatabaseSchema_1.default.save();
                    }
                }
            ...
            case "create-status-effect-modal":
                ...
                const statusEffectExistingData = yield statusEffectDatabaseSchema_1.default.findOne({
            ...
            case "delete-status-effect-modal":
                ...
                const deleteStatusEffectName = modalInteraction.fields
                    ...
                    .toLowerCase();
                // Validate the inputs
                const deleteStatusEffectData = yield statusEffectDatabaseSchema_1.default.findOne({
                ...
                deleteStatusEffectData.statusEffectUsers.forEach((user) => __awaiter(void 0, void 0, void 0, function* () {
                    yield userDatabaseSchema_1.default.findOne({ userId: user }).then((user) => {
                        if (user) {
                            user.statusEffects = user.statusEffects.filter((effect) => effect.statusEffectName !== deleteStatusEffectName);
                        }
                    });
                }));
                yield statusEffectDatabaseSchema_1.default.deleteOne({
                    statusEffectName: deleteStatusEffectName,
                });
                yield modalInteraction.reply({
            ...
            case "timeout-user-modal":
                ...
                //get duration in ms
                timeoutUserDuration = (0, ms_1.default)(timeoutUserDuration);
